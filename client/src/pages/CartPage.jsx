                ...
                <div className="max-w-4xl mx-auto px-4 py-4">
                    ...
                    <div className="mt-4 flex space-x-4">
                        ...
                        <button
                            ...
                            className={`px-4 py-2 rounded-lg ${preOrderEnabled
                                ? orderMode === 'preorder'
                    ...
                    <div className="lg:col-span-1">
                        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 sticky top-24">
                                        ...
                                        {slots.map((slot, index) => {
                                            ...
                                            return (
                                                <button
                                                    ...
                                                    className={`px-3 py-1 rounded-full text-sm ${selectedSlot === slot.slot
                                                        ? 'bg-red-600 text-white'
                                                        : availableSlots > 0
                                                            ? 'bg-gray-200 text-gray-700 hover:bg-gray-300'
                                                            : 'bg-gray-400 text-gray-600 cursor-not-allowed'
                            ...
                            <button
                                ...
                                className={`w-full py-3 px-4 rounded-lg font-medium transition-colors ${orderType && (orderMode === 'instant' || selectedSlot) && !isLoading
                            ...
                            <div className="p-6">
                                ...
                                <div className="flex space-x-3">
                                    ...
                                    <button
                                        ...
                                        className={`flex-1 py-3 px-4 rounded-lg font-medium transition-colors ${acceptedRules && !isLoading
                                            ? 'bg-red-600 hover:bg-red-700 text-white'
                                            : 'bg-gray-200 text-gray-500 cursor-not-allowed'
                                            }`}
                                    >
