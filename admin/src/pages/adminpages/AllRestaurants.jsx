              ...
              >
                ...
                <div className="p-6">
                  ...
                  <div className="flex items-center justify-between">
                    <span
                      className={`px-3 py-1 rounded-full text-xs font-medium ${restaurant.isAvailable
          ...
          <div className="bg-white rounded-xl p-6 max-w-md w-full max-h-[90vh] overflow-y-auto">
            ...
            <form onSubmit={handleEditSubmit} className="space-y-4">
              ...
              <div className="flex space-x-4 pt-2">
                <button
                  type="submit"
                  className={`flex-1 bg-red-600 text-white px-4 py-2 rounded-lg hover:bg-red-700 transition-colors ${isEditing ? 'opacity-50 cursor-not-allowed' : ''
                    }`}
                  disabled={isEditing}
                >
          ...
          <div className="bg-white rounded-xl p-6 max-w-md w-full">
            ...
            <form onSubmit={handlePasswordSubmit} className="space-y-4">
              ...
              <div className="flex space-x-4 pt-2">
                <button
                  type="submit"
                  className={`flex-1 bg-red-600 text-white px-4 py-2 rounded-lg hover:bg-red-700 transition-colors ${isSubmitting ? 'opacity-50 cursor-not-allowed' : ''
                    }`}
                  disabled={isSubmitting}
                >
