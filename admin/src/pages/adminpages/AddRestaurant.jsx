        ...
        <form onSubmit={handleSubmit} className="bg-white rounded-xl shadow-sm p-6 space-y-6">
          ...
          <div>
            ...
            <input
              ...
              className={`w-full px-4 py-3 border rounded-lg focus:ring-2 focus:ring-red-500 focus:border-red-500 transition-colors ${errors.restaurantid ? 'border-red-300 bg-red-50' : 'border-gray-300'
                }`}
              required
            />
            {errors.restaurantid && (
          ...
          <div>
            ...
            <input
              ...
              className={`w-full px-4 py-3 border rounded-lg focus:ring-2 focus:ring-red-500 focus:border-red-500 transition-colors ${errors.restaurantname ? 'border-red-300 bg-red-50' : 'border-gray-300'
                }`}
              required
            />
          ...
          <div>
            ...
            <input
              ...
              className={`w-full px-4 py-3 border rounded-lg focus:ring-2 focus:ring-red-500 focus:border-red-500 transition-colors ${errors.restaurantemail ? 'border-red-300 bg-red-50' : 'border-gray-300'
                }`}
              required
            />
          ...
          <div>
            ...
            <input
              ...
              maxLength="10"
              className={`w-full px-4 py-3 border rounded-lg focus:ring-2 focus:ring-red-500 focus:border-red-500 transition-colors ${errors.phone ? 'border-red-300 bg-red-50' : 'border-gray-300'
                }`}
              required
            />
            {errors.phone && (
          ...
          <div>
            ...
            <input
              ...
              className={`w-full px-4 py-3 border rounded-lg focus:ring-2 focus:ring-red-500 focus:border-red-500 transition-colors ${errors.restaurantpassword ? 'border-red-300 bg-red-50' : 'border-gray-300'
                }`}
              required
            />
          ...
          <div>
            ...
            {!imagePreview ? (
              <label
                ...
                className={`flex flex-col items-center justify-center w-full h-32 border-2 border-dashed rounded-lg cursor-pointer transition-colors ${errors.image ? 'border-red-300 bg-red-50' : 'border-gray-300 bg-gray-50 hover:bg-gray-100'
                  }`}
              >
          ...
          <div>
            ...
            <textarea
              ...
              rows={3}
              className={`w-full px-4 py-3 border rounded-lg focus:ring-2 focus:ring-red-500 focus:border-red-500 transition-colors resize-none ${errors.address ? 'border-red-300 bg-red-50' : 'border-gray-300'
                }`}
              required
            />
            {errors.address && (
