      ...
      <div id={`order-card-${order.orderId}`} className="bg-white rounded-xl shadow-md border border-gray-200 p-4 sm:p-5 flex flex-col h-full transition-transform duration-200 hover:scale-[1.02]">
        ...
        <div className="mb-3 p-3 bg-gray-50 rounded-lg">
          <div className="flex items-start justify-between">
            ...
            <div className={`px-3 py-1 rounded-full text-sm sm:text-base font-medium flex-shrink-0 ml-3 ${order.orderType === 'dining' ? 'bg-blue-100 text-blue-800' : 'bg-green-100 text-green-800'
              }`}>
            ...
            {order.items.map((item, index) => (
              <div key={index} className="flex justify-between items-center py-2 px-3 bg-gray-50 rounded">
                <div className="flex items-center space-x-3 flex-1 min-w-0">
                  ...
                  <span className={`w-3 h-3 rounded-full flex-shrink-0 ${item.foodtype === 'Vegetarian' ? 'bg-green-500' : 'bg-red-500'
                    }`}></span>
                </div>
                  ...
                  <div className="flex flex-col p-2">
                    {[
                      ...
                      <button
                        ...
                        className={`w-full text-left px-4 py-2 text-base font-medium rounded-lg transition-colors duration-200 ${filter === tab.key
              ...
              <div className="flex space-x-1 overflow-x-auto hide-scrollbar scroll-smooth p-2">
                {[
                  ...
                  <button
                    ...
                    className={`px-3 py-2 text-sm sm:text-base font-medium rounded-lg transition-colors duration-200 whitespace-nowrap ${filter === tab.key
                        ? 'bg-red-600 text-white'
                        : 'text-gray-600 hover:bg-red-50 hover:text-red-600'
                      }`}
                  >
