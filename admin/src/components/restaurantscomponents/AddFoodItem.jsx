        ...
        <div className="grid grid-cols-1 gap-4 sm:gap-6">
          ...
          <div>
            ...
            <input
              ...
              className={`w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-red-500 focus:border-transparent ${errors.dishname ? 'border-red-300 bg-red-50' : 'border-gray-300'
          ...
          <div>
            ...
            <select
              ...
              className={`w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-red-500 focus:border-transparent ${errors.category ? 'border-red-300 bg-red-50' : 'border-gray-300'
                } text-sm sm:text-base`}
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className={`w-full pl-8 pr-3 py-2 border rounded-lg focus:ring-2 focus:ring-red-500 focus:border-transparent ${errors.dineinPrice ? 'border-red-300 bg-red-50' : 'border-gray-300'
                  } text-sm sm:text-base`}
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                onWheel={(e) => e.target.blur()}
                className={`w-full pl-8 pr-3 py-2 border rounded-lg focus:ring-2 focus:ring-red-500 focus:border-transparent ${errors.takeawayPrice ? 'border-red-300 bg-red-50' : 'border-gray-300'
                  } text-sm sm:text-base`}
          ...
          <div>
            ...
            <textarea
              ...
              className={`w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-red-500 focus:border-transparent ${errors.description ? 'border-red-300 bg-red-50' : 'border-gray-300'
                } text-sm sm:text-base`}
