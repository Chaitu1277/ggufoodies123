            ...
            <div className="mb-3 sm:mb-4">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={`w-full pl-9 sm:pl-10 pr-10 sm:pr-12 py-2 text-sm border rounded-lg focus:ring-2 focus:ring-red-500 focus:border-transparent ${passwordModalError ? 'border-red-300 bg-red-50' : 'border-gray-200'
                    }`}
                />
                <button
                  type="button"
        ...
        <form onSubmit={handleSubmit} className="p-3 sm:p-6 space-y-4">
          ...
          <div>
            ...
            <div className="flex items-center space-x-3">
              <div
                className={`w-20 h-20 sm:w-24 sm:h-24 rounded-lg overflow-hidden border-2 border-gray-200 ${isEditing ? 'cursor-pointer' : 'cursor-default'
                  } relative group`}
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                disabled={!isEditing}
                className={`w-full pl-9 sm:pl-10 pr-3 py-2 text-sm border rounded-lg focus:ring-2 focus:ring-red-500 focus:border-transparent ${!isEditing ? 'bg-gray-50 text-gray-500' : errors.restaurantname ? 'border-red-300 bg-red-50' : 'border-gray-200'
                  }`}
              />
            </div>
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className={`w-full pl-9 sm:pl-10 pr-3 py-2 text-sm border rounded-lg focus:ring-2 focus:ring-red-500 focus:border-transparent ${!isEditing ? 'bg-gray-50 text-gray-500' : errors.phone ? 'border-red-300 bg-red-50' : 'border-gray-200'
                  }`}
              />
            </div>
            {errors.phone && (
          ...
          <div>
            ...
            <div className="relative">
              ...
              <textarea
                ...
                disabled={!isEditing}
                className={`w-full pl-9 sm:pl-10 pr-3 py-2 text-sm border rounded-lg focus:ring-2 focus:ring-red-500 focus:border-transparent resize-none ${!isEditing ? 'bg-gray-50 text-gray-500' : errors.address ? 'border-red-300 bg-red-50' : 'border-gray-200'
                  }`}
              />
            </div>
            {errors.address && (
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className={`w-full pl-9 sm:pl-10 pr-10 sm:pr-12 py-2 text-sm border rounded-lg focus:ring-2 focus:ring-red-500 focus:border-transparent ${errors.password ? 'border-red-300 bg-red-50' : 'border-gray-200'
                      }`}
                  />
                  <button
                    type="button"
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className={`w-full pl-9 sm:pl-10 pr-10 sm:pr-12 py-2 text-sm border rounded-lg focus:ring-2 focus:ring-red-500 focus:border-transparent ${errors.confirmPassword ? 'border-red-300 bg-red-50' : 'border-gray-200'
                      }`}
                  />
                  <button
                    type="button"
