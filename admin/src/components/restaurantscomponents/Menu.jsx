      ...
      <div className="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden flex flex-col h-full">
        <div className="relative">
          ...
          <div className="absolute top-2 left-2 flex space-x-2">
            <span
              className={`px-2 py-1 text-xs font-medium rounded-full ${item.isVeg ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'
                }`}
            >
          ...
          <div className="absolute top-2 right-2">
            <button
              ...
              className={`p-1.5 rounded-full ${item.isAvailable
        ...
        <div className="p-3 sm:p-4 flex flex-col flex-1">
          ...
          <div className="flex items-center justify-between mb-3">
            ...
            <div
              className={`px-2 py-1 rounded-full text-xs font-medium flex-shrink-0 ${item.isAvailable ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'
                }`}
            >
